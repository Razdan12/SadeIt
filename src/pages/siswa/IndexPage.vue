<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <q-card class="text-center bg-white" style="height: 86vh">
          <q-card-section>
            ...
            <div class="tw-mt-3 tw-flex tw-flex-wrap tw-flex-row">
              <div class="tw-w-1/3 tw-p-3 ">
                  ...
                  <q-card-section>
                    <div class="row flex justify-center items-center">
                      <div class="col-md-4">
                        ...
                        <q-img src="../../assets/sadeicon.png" style="width: 95%" />
                      </div>
            ...
            <div class=" flex tw-flex-wrap tw-mt-2 tw-flex-row">
              <div class="tw-w-1/3 tw-p-3">
